...
public class threadsender2 extends Thread{
    ...
    public threadsender2(String c, int d)
    {
    	this.c=c;
    	this.d=d;
    }
	...
	public void run()
	{   int e1;
	System.out.println(" Inside the sender of server 2");
		...
		System.out.println("MESSAGE RECIEVED IN THREADSENDER2  "+d1);
		System.out.println("LENGTH OF THE MESSAGE RECIEVED IN THREADSENDER2  "+d1.length());
		synchronized(this)
		{
			dstring=d1;
