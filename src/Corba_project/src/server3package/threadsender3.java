...
public class threadsender3 extends Thread
{
    ...
    public threadsender3(String c, int d)
    {
    	this.c=c;
    	this.d=d;
    }
	...
	{   int e1;
		...
		try 
		{
			...
			System.out.println("MESSAGE RECIEVED IN THREADSENDER3  "+d1);
			System.out.println("LENGTH OF THE MESSAGE RECIEVED IN THREADSENDER3  "+d1.length());
			synchronized(this)
			{
				dstring=d1;
